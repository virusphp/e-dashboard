            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="form-inline float-right mb-2 mr-sm-4">
                        <form id="form_chart" action="{{ route('daftar.kec.chartjs') }}" class="form-inline" role="search" >
                        ...
                        <form id="form_chart_harian" action="{{ route('daftar.kec.chartjs') }}" id="form" role="search" class="form-inline">
...
<script type="text/javascript">
    ...
    var nama_kecamatan = <?php echo $kecamatan; ?>;
